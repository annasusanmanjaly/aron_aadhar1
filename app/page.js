...
const Home = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="bg-black rounded-lg p-12 text-white">
        <h1 className="text-2xl font-bold mb-4">Connect Your Wallet</h1>
        {!isConnected ? (
          <div>
            <button
              className="bg-blue-400 hover:bg-slate-100 text-black font-bold py-2 px-4 rounded"
              onClick={onConnect}
            >
              Connect
            </button>
          ...
          <div className="app-wrapper">
            ...
            <div className='flex flex-row gap-4 p-3'>
              ...
              <button
                className="bg-blue-400 hover:bg-white text-black font-bold py-2 px-4 rounded"
